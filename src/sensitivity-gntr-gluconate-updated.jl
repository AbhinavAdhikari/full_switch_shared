...
function model_performance(parameter_guess_array,index)
   ...
   binding_parameter_dictionary = model_data_dictionary["binding_parameter_dictionary"]
    ...
    model_data_dictionary["sigma_70_half_life"] = parameter_guess_array[44]
...
# setup paths -
path_to_ensemble_file = "./simulated/poets_ensemble/PC_T5.dat"
 
# compute a sensitivity array for the AUC of each species -
species_index_array = [9 10 14 15] #only doing for Venus and BFP- just try the 3 species ie mRNA Venus Protein Venus and Protein BFP, because we only have experimental data for those three. 
...
fname = "./simulated/sensitivity_results/Sensitivity_matrix_2.dat"
